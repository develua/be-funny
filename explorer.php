...
<head>
	...
	<link rel="stylesheet" href="/other/css_explorer/style.css" />
	<link rel="icon" href="/other/img_explorer/favicon.ico" type="image/x-icon" />
	<link rel="shortcut icon" href="/other/img_explorer/favicon.ico" />
	<script type="text/javascript" src="/other/js_explorer/mootools.js"></script>
	<script type="text/javascript" src="/other/js_explorer/qtabs.js"></script>
    <style>
    .return {
        display: none;
    }
	...
	<div class="main" id="current-ex2">
		<div class="qtcontent">
			...
			<table class="brows" cellspacing="0">
				<tr>
					<td><a href="http://www.microsoft.com/windows/Internet-explorer/default.aspx" onclick="return !window.open(this.href)"><img src="/other/img_explorer/ie.jpg" alt="Internet Explorer" /></a></td>
					<td><a href="http://www.opera.com/download/" onclick="return !window.open(this.href)"><img src="/other/img_explorer/op.jpg" alt="Opera Browser" /></a></td>
					<td><a href="http://www.mozilla.com/firefox/" onclick="return !window.open(this.href)"><img src="/other/img_explorer/mf.jpg" alt="Mozilla Firefox" /></a></td>
					<td><a href="http://www.google.com/chrome" onclick="return !window.open(this.href)"><img src="/other/img_explorer/gc.jpg" alt="Google Chrome" /></a></td>
					<td><a href="http://www.apple.com/safari/download/" onclick="return !window.open(this.href)"><img src="/other/img_explorer/as.jpg" alt="Apple Safari" /></a></td>
				</tr>
				<tr class="brows_name">
		...
		<div class="qtcontent">
			...
			<p>This videocourse is built on the advanced, modern technologies and does not support Internet Explorer version 6.</p>
